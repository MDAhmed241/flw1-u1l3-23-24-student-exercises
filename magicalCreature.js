...
let creatureDescription ="Dragons are reptiles with large wings"
...
vistor=Age=Math.floor(visitorAge);
...
let creatureName1= "Elephant";
let creatureDescription1= "Elephants are mammals with tusks";
let isFriendly1= false;
let visitorAge1= Math.random(60);
vistor=Age=Math.floor(visitorAge1);
console.log(visitorAge1);
